...
class NeuralSTPPConfig(BaseModelConfig):
    ...
    def _parse_temporal_hidden_dims(cfg: Dict[str, Any], fallback_hidden_dim: int) -> tuple[int, ...]:
        from unified_stpp.models.temporal_models.neural_point_process import _normalize_hidden_dims
    ...
    def from_dict(
        ...
        *,
        ...
        from unified_stpp.models.model_registry import get_spatial_cls
