...
def _build_raw_datasets(data_config, train_seqs, val_seqs, test_seqs):
    from seahorse.data.dataset import SlidingWindowSTPPDataset, STPPDataset
...
def _build_sliding_window_datasets(data_config, train_seqs, val_seqs, test_seqs):
    ...
    from seahorse.data.dataset import PaperSlidingWindowDataset
...
def _canonical_collate():
    from seahorse.data.dataset import collate_fn
    return collate_fn
