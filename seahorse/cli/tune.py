...
from seahorse.cli._args import add_config_source_args, add_data_args, add_hpo_args
...
def execute(args) -> None:
    ...
    from seahorse.benchmark.hpo import build_hpo_manifest, run_hpo, write_trial_history
    from seahorse.config.schema import DataConfig, STPPConfig
    from seahorse.config.tuning import TuningConfig
    from seahorse.data.resolution import build_single_data_provenance
