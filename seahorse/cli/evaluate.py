...
def _add_metrics_subparser(sub) -> None:
    from seahorse.evaluation.profiles import profile_names
...
def _execute_metrics(args) -> None:
    from seahorse.evaluation.evaluator import evaluate
    from seahorse.evaluation.predictive.benchmark import (
    ...
    from seahorse.evaluation.runtime import load_run_result, resolve_device
...
def _load_predictive_samples_for_report(
    *,
    ...
    from seahorse.evaluation.bundle_io import load_predictive_samples_artifact
...
def _execute_predictive_compare(args) -> None:
    from seahorse.evaluation.bundle_io import (
...
def _execute_merge_artifacts(args) -> None:
    from seahorse.evaluation.artifacts import merge_predictive_samples
    from seahorse.evaluation.bundle_io import (
