...
from seahorse.cli._args import add_hpo_args
...
def execute(args) -> None:
    from seahorse.benchmark import Benchmark
    from seahorse.config import BenchmarkConfig, TuningConfig
    from seahorse.config.schema import DataConfig
    from seahorse.data.resolution import build_benchmark_data_provenance
    from seahorse.runner.artifacts import make_bench_run_id
    from seahorse.utils import parse_overrides
