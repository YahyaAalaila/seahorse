...
from seahorse.utils import deep_update, parse_overrides
...
class DataConfig(BaseModel):
    ...
    def resolve_data(
        ...
        *,
        ...
        logic to :mod:`seahorse.data.resolution`.
        """
        from seahorse.data.resolution import resolve_data_source
...
class ModelConfig(BaseModel):
    ...
    to :func:`seahorse.registry.build_model` as the override dict.
    """
...
class STPPConfig(BaseModel):
        ...
        *,
        ...
        if sanitize and _has_search_space_syntax(raw):
            ...
            warnings.warn(
                ...
                "'python -m seahorse tune' instead.",
                UserWarning,
                stacklevel=2,
            )
    ...
    def build_data_bundle(
        ...
        """
        from seahorse.data.registry import DataBundle, DataRegistry
        from seahorse.models.configs import ConfigRegistry
