...
- a provisional name like `nsmpp_deepbasis_provisional` may need to become `nsmpp`, with status metadata carrying the provisional/canonical distinction if needed
...
- [ ] review `nsmpp_deepbasis_provisional` and decide final public name/status
