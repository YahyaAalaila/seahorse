"""
Archive snapshot of ``unified_stpp.data.synthetic`` taken during cleanup.

This copy is preserved for review before any more aggressive removals from the
active synthetic-data module.
"""
